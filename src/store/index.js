...
export default createStore({
  state: {
    portfolioList: [
      ...
      { img: require('@/assets/img6.png'), date: 'Oct, 2023', text: 'ASCWW', link: 'https://ascww.org/',githubLink:'https://github.com/m-hemdan/ascww_website',  animate:'animated fadeInDown animate__delay-6s',
        subText: 'Assuit Company for water and waste water company website can serve a variety of purposes, including inqure the bill of water , search, social, or registeration in the school of water. it consists of multiple pages in Arabic language only, such as tenders pages, news pages, advices pages, and more. The visual aspect of a website includes its layout, color scheme, typography, and structure. A well-designed website ensures user-friendliness and accessibility. '}
    ]
  },
  getters: {
  },
